                    ...
                    <div class="auth-box card">
                        <div class="card-block">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center txt-primary">Зарегистрироваться</h3>
                                </div>
                            </div>
                            @if ($errors->any())
                            ...
                            <div class="form-group form-primary">
                                ...
                                <label class="float-label">ФИО</label>
                            </div>
                            <div class="form-group form-primary">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-primary">
                                        <input type="password" name="password_confirmation" class="form-control"
                                               required>
                                        <span class="form-bar"></span>
                                        <label class="float-label">Подтвердите пароль</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <p class="text-inverse text-left">У вас уже есть аккаунт?<a href="/login">
                                    <b>Войдите здесь </b></a>!</p>
                        </div>
                    </div>
                </form>
            </div>
