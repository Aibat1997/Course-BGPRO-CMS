                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Добавить/Редактировать ответ</h5>
                                    <div class="col-sm-10" style="display: flex;justify-content: flex-end;color:#fff">
                                        <a href="/admin/{{ $question->id }}/answers" class="btn btn-danger m-b-0">Назад</a>
                                    </div>
                                </div>
                                <div class="card-block">
                                    @if (!empty($answer))
                                    <form action="/admin/{{ $question->id }}/answers/{{ $answer->id }}" method="POST" enctype="multipart/form-data" class="col-lg-12 col-xl-12 row">
                                        @method('PUT')
                                    @else
                                    <form action="/admin/{{ $question->id }}/answers" method="POST" enctype="multipart/form-data" class="col-lg-12 col-xl-12 row">
                                    @endif
                                        @csrf
                                                        ...
                                                        <div class="col-sm-12 col-lg-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="name_ru"
                                                                    placeholder="Название (Рус)" class="form-control" value="{{ !empty($answer) ? $answer->name_ru : old('name_ru') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-12 col-lg-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="name_kz"
                                                                    placeholder="Название (Каз)" class="form-control" value="{{ !empty($answer) ? $answer->name_kz : old('name_kz') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-12 col-lg-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="name_en"
                                                                    placeholder="Название (Анг)" class="form-control" value="{{ !empty($answer) ? $answer->name_en : old('name_en') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-4 m-b-30">
                                                    <div class="radio radio-primary radio-inline">
                                                        <h4 class="sub-title">Правильный</h4>
                                                        <label>
                                                            <input type="radio" value="1" name="is_correct" required {{ !empty($answer) && $answer->is_correct == 1 ? "checked" : "" }}>
                                                            Да
                                                        </label>
                                                        <label>
                                                            @if (empty($answer))
                                                                <input type="radio" value="0" name="is_correct" checked>
                                                            @else
                                                                <input type="radio" value="0" name="is_correct" {{ $answer->is_correct == 0 ? "checked" : "" }}>
                                                            @endif
                                                            Нет
                                                        </label>
                                                    </div>
