                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Добавить/Редактировать урок</h5>
                                    <div class="col-sm-10" style="display: flex;justify-content: flex-end;color:#fff">
                                        <a href="/admin/{{ $course->id }}/lessons" class="btn btn-danger m-b-0">Назад</a>
                                    </div>
                                </div>
                                <div class="card-block">
                                    @if (!empty($lesson))
                                    <form action="/admin/{{ $course->id }}/lessons/{{ $lesson->id }}" method="POST" enctype="multipart/form-data" class="col-lg-12 col-xl-12 row">
                                        @method('PUT')
                                    @else
                                    <form action="/admin/{{ $course->id }}/lessons" method="POST" enctype="multipart/form-data" class="col-lg-12 col-xl-12 row">
                                    @endif
                                        @csrf
                                                        ...
                                                        <div class="col-sm-12 col-lg-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="name_ru"
                                                                    placeholder="Название (Рус)" class="form-control" value="{{ !empty($lesson) ? $lesson->name_ru : old('name_ru') }}">
                                                            </div>
                                                            <h4 class="sub-title">Описание</h4>
                                                            <textarea rows="5" cols="5" class="form-control" id="editor" name="content_ru">{!! !empty($lesson) ? $lesson->content_ru : old('content_ru') !!}</textarea><br>
                                                            <div class="input-group">
                                                                <span class="input-group-prepend">
                                                                    <label class="input-group-text">Видео с Vimeo</label>
                                                                </span>
                                                                <input type="text" name="video_ru"
                                                                    placeholder="Ссылка" class="form-control" value="{{ !empty($lesson) ? $lesson->video_ru : old('video_ru') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-12 col-lg-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="name_kz"
                                                                    placeholder="Название (Каз)" class="form-control" value="{{ !empty($lesson) ? $lesson->name_kz : old('name_kz') }}">
                                                            </div>
                                                            <h4 class="sub-title">Описание</h4>
                                                            <textarea rows="5" cols="5" class="form-control" id="editor1" name="content_kz">{!! !empty($lesson) ? $lesson->content_kz : old('content_kz') !!}</textarea><br>
                                                            <div class="input-group">
                                                                <span class="input-group-prepend">
                                                                    <label class="input-group-text">Видео с Vimeo</label>
                                                                </span>
                                                                <input type="text" name="video_kz"
                                                                    placeholder="Ссылка" class="form-control" value="{{ !empty($lesson) ? $lesson->video_kz : old('video_kz') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-12 col-lg-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="name_en"
                                                                    placeholder="Название (Анг)" class="form-control" value="{{ !empty($lesson) ? $lesson->name_en : old('name_en') }}">
                                                            </div>
                                                            <h4 class="sub-title">Описание</h4>
                                                            <textarea rows="5" cols="5" class="form-control" id="editor2" name="content_en">{!! !empty($lesson) ? $lesson->content_en : old('content_en') !!}</textarea><br>
                                                            <div class="input-group">
                                                                <span class="input-group-prepend">
                                                                    <label class="input-group-text">Видео с Vimeo</label>
                                                                </span>
                                                                <input type="text" name="video_en"
                                                                    placeholder="Ссылка" class="form-control" value="{{ !empty($lesson) ? $lesson->video_en : old('video_en') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-lg-12">
                                                    <div class="input-group">
                                                        ...
                                                        @php
                                                            $sort_num = $course->lessons->count();
                                                        @endphp

                                                        <input type="number" name="sort_num" placeholder="Стоимость"
                                                            class="form-control" value="{{ !empty($lesson) ? $lesson->sort_num : $sort_num + 1 }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
